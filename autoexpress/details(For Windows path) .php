<!-- Path for python script according to windows -->
<?php
        ...
        <div class="center_section">
            <div id="vehicle_info">
                ...
                <div id="vehicle_info_right">
                    ...
                    <p style="display:none;" id='python_script'><?php //change this path according to the main.py file
                        echo shell_exec('python C:\xampp\htdocs\ProjCar\main.py 100 "'.$currCar[0]->getHeadingTitle()).'"'; ?> </p>
                   </div>
                   <br>
