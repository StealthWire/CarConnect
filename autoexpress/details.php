    ...
    <div id="content_section">
        ...
        <div class="center_section">
            <div id="vehicle_info">
                ...
                <!--Display tweets script--> <!-- TODO: update path for python script -->
                    <p style="display:none;" id='viewt_script'><?php echo shell_exec('/Users/*user_name*/.pyenv/shims/python /Applications/XAMPP/xamppfiles/htdocs/ProjCar/twitter/viewTwee.py');?></p>
