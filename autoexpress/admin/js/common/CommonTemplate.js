function CommonTemplate() {
    ...
    this.updateCarInfoModalContent = function () {
        return '   <div class="row">  '+
            ...
            '   								<td>  '+
            '   									<input type="number" name="price" id="price" title="price" min="0" max="99999999" required value="{{_price}}" />  '+
            '   									<b style="font-size: 10px; color: red;" id="price-err">&nbsp;</b>  '+
            '   								</td>  '+
            '   							</tr>  '+
            '   							<tr>  '+
            '   								<td>Mileage(Km/L)<span class="input-required"> *</span></td>  '+
            '   								<td>  '+
            '   									<input type="number" name="mileage" id="mileage" title="mileage" min="0" max="99999999" required/ value="{{_mileage}}">  '+
            ...
            '                               <tr>  '  +
             ...
             '                             <tr> '+
            '                                          <td>Exterior Color <span class="input-required"> *</span></td>'+
            '                                          <td>'+
            '                                             <input value="{{_exterior}}" type="text" name="exterior" id="exterior" minlength="0" maxlength="150" title="exterior" required> '+
            '                                              <b style="font-size: 10px; color: red;" id="exterior-err">&nbsp;</b> '+
            '                                      </td> '+
            '                                </tr>'+

             '                                       <tr> '+
             '                                         <td>Interior Color <span class="input-required"> *</span></td>'+
             '                                         <td>'+
             '                                               <input value="{{_interior}}" type="text" name="interior" id="interior" minlength="0" maxlength="150" title="interior" required>'+
             '                                               <b style="font-size: 10px; color: red;"  id="interior-err">&nbsp;</b>'+
             '                                           </td>'+
              '                                 </tr>'+
    ...
    '   		                                    <input type="radio" name="status" id="status" value="SOLD" title="status"> Sold  '  +
        ...
        '                                   </tr>  '  +
            ...
            '   							</tr>  '+
             ...
             '                                           <td>'+
             '                                               <input value="{{_fuel}}" type="text" name="fuel" id="fuel"  minlength="0" maxlength="150" title="fuel" required>'+
             '                                               <b style="font-size: 10px; color: red;" id="fuel-err">&nbsp;</b>'+
            '                                          </td>'+
            '                                        </tr>'+
            ...
            '                              <tr>'+
            '                                            <td>Safety Rating<span class="input-required"> *</span></td>'+
             '                                           <td><input value="{{_safety}}" type="text" name="safety" id="safety" title="safety" required min="0" max="5">'+
             '                                               <b style="font-size: 10px; color: red;"  id="safety-err">&nbsp;</b>'+
            '                                            </td>'+
             '                                       </tr>'+
