...
class Vehicle implements JsonSerializable
{
     ...
     * @param $_dateAdded
     */
    public function __construct($_vehicleId, $_make, $_yearMade, $_model, $_price, $_mileage, $_transmission, $_drivetrain, $_exterior, $_interior, $_engineCapacity, $_safety, $_category, $_cylinder, $_fuel, $_doors, $_status, $_dateAdded)
    {
