...
define("MAX_PRICE_MILEAGE", 99999999);
...
class AdvanceSearchDAO extends CarDAO
{
    ...
    function getSearchResult($searchArray) {
        $sql = "SELECT\n"
            ...
            . " `yearMade`,\n"
            . " `model`,\n"
            . " `price`,\n" // commas replaced with empty and then casted to integer
            . " `mileage`,\n"
            . " `transmission`,\n"
            . " `drivetrain`,\n"
            . " `engineCapacity`,\n"
            ...
            . " AND cast(replace(price,\",\",\"\") as unsigned) BETWEEN '".$searchArray['minPrice']."' AND '".$searchArray['maxPrice']."' \n"
