                                        ...
                                        <div class="panel panel-primary">
                                            ...
                                            <div class="panel-body">
                                                <table cellspacing="1" id="car-general-info-table">
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <input type="number" name="price" id="price"
                                                                   title="price" min="0" max="99999999" required/>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <input type="number" name="mileage" id="mileage"
                                                                   title="mileage" min="0" max="99999999" required/>
                                                            <b style="font-size: 10px;  color: red;"
                                                               id="mileage-err">&nbsp;</b>
                                                        </td>
                                                    </tr>
                                                    ...
                                                    <tr>
                                                      <td>Exterior Color <span class="input-required"> *</span>
                                                        </td>
                                                        <td>
                                                            <input type="text" name="exterior" id="exterior"
                                                                   minlength="0" maxlength="150" title="Color"
                                                                   required>
                                                            <b style="font-size: 10px; color: red;"
                                                               id="exterior-err">&nbsp;</b>
                                                        </td>
                                                    ...
                                                    <tr>
                                                      <td>Interior Color <span class="input-required"> *</span>
                                                        </td>
                                                        <td>
                                        ...
                                        <div class="panel panel-primary">
                                            ...
                                            <div class="panel-body">
                                                <table>
                                                    ...
                                                    <tr>
                                                      <td>Fuel Type <span class="input-required"> *</span>
                                                        </td>
                                                        <td>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <input type="text" name="safety" id="safety"
                                                                   title="safety" required min="0" max="5">
                                                            <b style="font-size: 10px; color: red;"
                                                               id="safety-err">&nbsp;</b>
                                                        </td>
                                                    </tr>
