...
<body>
<div id="loading1">
  <img id="loading-image1" src="/ProjCar/autoexpress/image/loader.gif" alt="Loading..." />
</div>
<div class="container_custom">
</div>
<div id="details-container"  style="width:80%; margin:auto;">
    <div id="content_section">
        <div id="vehicle_title"><h3><?php echo $currCar[0]->getHeadingTitle(); ?></h3></div>
        <div style="clear: both" ></div>
        <div class="center_section" style="width: 100%; margin: auto; float: left;">
            <?php if($numImg > 0) { ?>
            ...
            <div id="vehicle_info">
                ...
                <div id="vehicle_info_right">
                   <br>
                    ...
                    <br>
                    <p><?php echo wordwrap($currCar[0]->getExterior(),30,"<br />\n") ?></p>
                    <br>
                    ...
                    <p style="display:none" id='python_script'><?php //TODO : change this path according to the main.py file
                       echo shell_exec('/Users/*user_name*/.pyenv/shims/python /Applications/XAMPP/xamppfiles/htdocs/ProjCar/main.py 100 "'.$currCar[0]->getHeadingTitle().'"');?>
                        </p>
                </div>
                   <br><br>

                    <!--Display Tweets script --> <!-- TODO : Update path -->
                    <div style="display:none;" id='viewt_script'><?php echo shell_exec('/Users/*user_name*/.pyenv/shims/python /Applications/XAMPP/xamppfiles/htdocs/ProjCar/twitter/viewTwee.py');?></div>

                    <!-- chart code-->
                    <div id="piechart" style="background-color:#fff;"></div>
                        <br>
                        <button id="disp_tweets"> View Tweets!</button>
                            <iframe id="tweetdisp" src="http://localhost:5000" height="2500px" width="100%" style="display:none"></iframe><br>
                <div style="clear: both" ></div>
            </div>
        </div>
        <div style="clear: both" ></div>
...
//console.log(intArr); debug to check
...
<script language="javascript" type="text/javascript">
    window.onload = function(){ document.getElementById("loading1").style.display = "none" }
</script>
